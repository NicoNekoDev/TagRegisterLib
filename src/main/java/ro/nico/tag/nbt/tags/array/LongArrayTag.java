package ro.nico.tag.nbt.tags.array;
...
import ro.nico.tag.nbt.tags.primitive.LongTag;
...
public class LongArrayTag extends ArrayTag<Long> {
     ...
     */
    public LongArrayTag(String name, @NotNull long[] value) {
        this.setName(name);
        this.setValue(value);
    }
    ...
    @Override
    public LongArrayTag write(DataOutput output, int depth) throws IOException {
    ...
    @Override
    public LongArrayTag read(DataInput input, int depth) throws IOException {
    ...
    @Override
    public LongArrayTag fromJson(JsonObject json, int depth) throws IOException {
    ...
    @Override
    public Long set(int index, @NotNull Long element) {
        return this.value[index] = element;
    }

    @Override
    public void insert(int index, @NotNull Long... elements) {
